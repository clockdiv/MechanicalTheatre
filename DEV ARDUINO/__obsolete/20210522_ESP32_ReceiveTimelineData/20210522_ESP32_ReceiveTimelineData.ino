...
const uint8_t pinBuzzer = 15;

// Stepper-Motor #1
const uint8_t pinStepper1Dir = 4;
const uint8_t pinStepper1Step = 16;
...
char keyframeValuesBin[MAX_FRAMES * 2]; // the two-byte pairs of keyframes. assigned by receive_keyframes()
...
/* Serial Monitor                       */
/* ------------------------------------ */
void read_keyframes_from_file(String dumpFilename) {
