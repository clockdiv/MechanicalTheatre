// This is a modified Version of the orignal AccelStepper Library.
// Two functions were added to init the stepper after it's declaration:
// void AccelStepper::setPins(uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4);
...
public:
	...
	/// additional function to set the pins later
    void	setPins(uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5);
